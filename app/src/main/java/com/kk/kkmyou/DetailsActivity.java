...
public class DetailsActivity extends YouTubeBaseActivity implements YouTubePlayer.OnInitializedListener {
    ...
    private ExpandableTextView expandableDes;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textViewDate.setText("Upload on "+youtubeDataModel.getPublishedAt());
  ...
  */
    ...
    public void share_btn_pressed(View view) {
        ...
        startActivity(Intent.createChooser(sendIntent, "Share this video on"));
    }
