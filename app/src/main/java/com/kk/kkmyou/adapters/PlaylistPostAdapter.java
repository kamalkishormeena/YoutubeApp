package com.kk.kkmyou.adapters;
...
/**
 * Created by kk on 20-02-2018.
 */
public class PlaylistPostAdapter extends RecyclerView.Adapter<PlaylistPostAdapter.YoutubePostHolder> {
    ...
    public PlaylistPostAdapter(Context mContext, ArrayList<YoutubeDataModel> dataSet, OnItemClickListener listener) {
    ...
    public YoutubePostHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.youtube_play_layout,parent,false);
